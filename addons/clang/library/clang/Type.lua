...
---@field addressSpace integer Returns the address space of the given type.
---@field alignOf integer Return the alignment of a type in bytes as per C++[expr.alignof] standard. <br><br>If the type declaration is invalid, CXTypeLayoutError_Invalid is returned. If the type declaration is an incomplete type, CXTypeLayoutError_Incomplete is returned. If the type declaration is a dependent type, CXTypeLayoutError_Dependent is returned. If the type declaration is not a constant size type, CXTypeLayoutError_NotConstantSize is returned.
...
---@field arraySize integer Return the array size of a constant array. <br><br>If a non-array type is passed in, -1 is returned.
