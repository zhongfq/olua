...
---@field underlyingType clang.Type Retrieve the underlying type of a typedef declaration. <br><br>If the cursor does not reference a typedef declaration, an invalid type is returned.
