...
static int _olua_bool_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.bool");
    olua_check_object(L, 2, &arg1, "olua.bool");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_bool *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_bool_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.bool"))) {
            // void copyfrom(olua_bool *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.bool")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_bool *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.bool")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_bool *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.bool")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_bool *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_string_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.string");
    olua_check_object(L, 2, &arg1, "olua.string");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_string *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_string_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.string"))) {
            // void copyfrom(olua_string *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.string")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_string *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.string")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_string *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.string")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_string *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int8_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.int8");
    olua_check_object(L, 2, &arg1, "olua.int8");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_int8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_int8_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.int8"))) {
            // void copyfrom(olua_int8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.int8")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_int8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.int8")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_int8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.int8")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_int8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int8_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_int8 *create(@optional size_t len)
...
static int _olua_int8_sub$1(lua_State *L)
{
    ...
    // olua_int8 *sub(size_t from, @optional size_t to)
...
static int _olua_uint8_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.uint8");
    olua_check_object(L, 2, &arg1, "olua.uint8");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_uint8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_uint8_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.uint8"))) {
            // void copyfrom(olua_uint8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.uint8")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_uint8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.uint8")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_uint8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.uint8")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_uint8 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_uint8_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_uint8 *create(@optional size_t len)
...
static int _olua_uint8_sub$1(lua_State *L)
{
    ...
    // olua_uint8 *sub(size_t from, @optional size_t to)
...
static int _olua_int16_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.int16");
    olua_check_object(L, 2, &arg1, "olua.int16");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_int16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_int16_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.int16"))) {
            // void copyfrom(olua_int16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.int16")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_int16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.int16")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_int16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.int16")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_int16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int16_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_int16 *create(@optional size_t len)
...
static int _olua_int16_sub$1(lua_State *L)
{
    ...
    // olua_int16 *sub(size_t from, @optional size_t to)
...
static int _olua_uint16_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.uint16");
    olua_check_object(L, 2, &arg1, "olua.uint16");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_uint16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_uint16_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.uint16"))) {
            // void copyfrom(olua_uint16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.uint16")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_uint16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.uint16")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_uint16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.uint16")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_uint16 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_uint16_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_uint16 *create(@optional size_t len)
...
static int _olua_uint16_sub$1(lua_State *L)
{
    ...
    // olua_uint16 *sub(size_t from, @optional size_t to)
...
static int _olua_int32_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.int32");
    olua_check_object(L, 2, &arg1, "olua.int32");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_int32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_int32_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.int32"))) {
            // void copyfrom(olua_int32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.int32")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_int32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.int32")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_int32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.int32")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_int32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int32_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_int32 *create(@optional size_t len)
...
static int _olua_int32_sub$1(lua_State *L)
{
    ...
    // olua_int32 *sub(size_t from, @optional size_t to)
...
static int _olua_uint32_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.uint32");
    olua_check_object(L, 2, &arg1, "olua.uint32");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_uint32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_uint32_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.uint32"))) {
            // void copyfrom(olua_uint32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.uint32")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_uint32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.uint32")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_uint32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.uint32")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_uint32 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_uint32_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_uint32 *create(@optional size_t len)
...
static int _olua_uint32_sub$1(lua_State *L)
{
    ...
    // olua_uint32 *sub(size_t from, @optional size_t to)
...
static int _olua_int64_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.int64");
    olua_check_object(L, 2, &arg1, "olua.int64");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_int64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_int64_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.int64"))) {
            // void copyfrom(olua_int64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.int64")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_int64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.int64")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_int64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.int64")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_int64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int64_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_int64 *create(@optional size_t len)
...
static int _olua_int64_sub$1(lua_State *L)
{
    ...
    // olua_int64 *sub(size_t from, @optional size_t to)
...
static int _olua_uint64_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.uint64");
    olua_check_object(L, 2, &arg1, "olua.uint64");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_uint64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_uint64_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.uint64"))) {
            // void copyfrom(olua_uint64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.uint64")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_uint64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.uint64")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_uint64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.uint64")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_uint64 *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_uint64_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_uint64 *create(@optional size_t len)
...
static int _olua_uint64_sub$1(lua_State *L)
{
    ...
    // olua_uint64 *sub(size_t from, @optional size_t to)
...
static int _olua_short_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.short");
    olua_check_object(L, 2, &arg1, "olua.short");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_short *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_short_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.short"))) {
            // void copyfrom(olua_short *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.short")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_short *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.short")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_short *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.short")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_short *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_ushort___index(lua_State *L)
{
    ...
    unsigned short ret = self->__index(arg1);
    int num_ret = olua_push_integer(L, ret);
...
static int _olua_ushort_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.ushort");
    olua_check_object(L, 2, &arg1, "olua.ushort");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_ushort *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_ushort_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.ushort"))) {
            // void copyfrom(olua_ushort *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.ushort")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_ushort *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.ushort")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_ushort *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.ushort")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_ushort *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_int_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.int");
    olua_check_object(L, 2, &arg1, "olua.int");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_int *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_int_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.int"))) {
            // void copyfrom(olua_int *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.int")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_int *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.int")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_int *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.int")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_int *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_uint___index(lua_State *L)
{
    ...
    unsigned int ret = self->__index(arg1);
    int num_ret = olua_push_integer(L, ret);
...
static int _olua_uint_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.uint");
    olua_check_object(L, 2, &arg1, "olua.uint");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_uint *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_uint_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.uint"))) {
            // void copyfrom(olua_uint *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.uint")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_uint *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.uint")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_uint *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.uint")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_uint *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_long_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.long");
    olua_check_object(L, 2, &arg1, "olua.long");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_long *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_long_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.long"))) {
            // void copyfrom(olua_long *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.long")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_long *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.long")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_long *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.long")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_long *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_ulong___index(lua_State *L)
{
    ...
    unsigned long ret = self->__index(arg1);
    int num_ret = olua_push_integer(L, ret);
...
static int _olua_ulong_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.ulong");
    olua_check_object(L, 2, &arg1, "olua.ulong");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_ulong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_ulong_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.ulong"))) {
            // void copyfrom(olua_ulong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.ulong")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_ulong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.ulong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_ulong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.ulong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_ulong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_llong___index(lua_State *L)
{
    ...
    long long ret = self->__index(arg1);
    int num_ret = olua_push_integer(L, ret);
...
static int _olua_llong_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.llong");
    olua_check_object(L, 2, &arg1, "olua.llong");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_llong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_llong_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.llong"))) {
            // void copyfrom(olua_llong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.llong")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_llong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.llong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_llong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.llong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_llong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_ullong___index(lua_State *L)
{
    ...
    unsigned long long ret = self->__index(arg1);
    int num_ret = olua_push_integer(L, ret);
...
static int _olua_ullong_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.ullong");
    olua_check_object(L, 2, &arg1, "olua.ullong");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_ullong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_ullong_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.ullong"))) {
            // void copyfrom(olua_ullong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.ullong")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_ullong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.ullong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_ullong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.ullong")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_ullong *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_float_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.float");
    olua_check_object(L, 2, &arg1, "olua.float");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_float *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_float_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.float"))) {
            // void copyfrom(olua_float *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.float")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_float *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.float")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_float *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.float")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_float *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_double_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.double");
    olua_check_object(L, 2, &arg1, "olua.double");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_double *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_double_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.double"))) {
            // void copyfrom(olua_double *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.double")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_double *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.double")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_double *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.double")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_double *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_ldouble___index(lua_State *L)
{
    ...
    long double ret = self->__index(arg1);
    int num_ret = olua_push_number(L, ret);
...
static int _olua_ldouble_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.ldouble");
    olua_check_object(L, 2, &arg1, "olua.ldouble");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_ldouble *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_ldouble_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.ldouble"))) {
            // void copyfrom(olua_ldouble *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.ldouble")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_ldouble *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.ldouble")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_ldouble *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.ldouble")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_ldouble *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_size_t_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.size_t");
    olua_check_object(L, 2, &arg1, "olua.size_t");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_size_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_size_t_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.size_t"))) {
            // void copyfrom(olua_size_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.size_t")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_size_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.size_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_size_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.size_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_size_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_ssize_t_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.ssize_t");
    olua_check_object(L, 2, &arg1, "olua.ssize_t");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_ssize_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_ssize_t_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.ssize_t"))) {
            // void copyfrom(olua_ssize_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.ssize_t")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_ssize_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.ssize_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_ssize_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.ssize_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_ssize_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_time_t___gc(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.time_t");
...
static int _olua_time_t___olua_move(lua_State *L)
{
    ...
    olua_push_object(L, self, "olua.time_t");
...
static int _olua_time_t_copyfrom$1(lua_State *L)
{
    ...
    olua_to_object(L, 1, &self, "olua.time_t");
    olua_check_object(L, 2, &arg1, "olua.time_t");
    olua_check_integer(L, 3, &arg2);
    olua_check_integer(L, 4, &arg3);
    olua_check_integer(L, 5, &arg4);

    // void copyfrom(olua_time_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    self->copyfrom(arg1, arg2, arg3, arg4);
...
static int _olua_time_t_copyfrom(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "olua.time_t"))) {
            // void copyfrom(olua_time_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 2) {
        // if ((olua_is_object(L, 2, "olua.time_t")) && (olua_is_integer(L, 3))) {
            // void copyfrom(olua_time_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "olua.time_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4))) {
            // void copyfrom(olua_time_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "olua.time_t")) && (olua_is_integer(L, 3)) && (olua_is_integer(L, 4)) && (olua_is_integer(L, 5))) {
            // void copyfrom(olua_time_t *obj, @optional size_t from, @optional size_t len, @optional size_t to)
...
static int _olua_time_t_create$1(lua_State *L)
{
    ...
    // @name(new) static olua_time_t *create(@optional size_t len)
    olua_time_t *ret = olua_time_t::create(arg1);
    int num_ret = olua_push_object(L, ret, "olua.time_t");
...
static int _olua_time_t_create$2(lua_State *L)
{
    ...
    // @name(new) static olua_time_t *create(@optional size_t len)
    olua_time_t *ret = olua_time_t::create();
    int num_ret = olua_push_object(L, ret, "olua.time_t");
...
static int _olua_time_t_sub$1(lua_State *L)
{
    ...
    // olua_time_t *sub(size_t from, @optional size_t to)
    olua_time_t *ret = self->sub(arg1, arg2);
    int num_ret = olua_push_object(L, ret, "olua.time_t");
